...
const InputContainer = (): JSX.Element =>  {
  ...
  return (
    <div className={`w-[434px] h-[68px] mt-12 rounded-[8px] bg-white ${xBetween}`}>
      <input className="w-[220px] h-auto ml-[24px] text-black font-thin text-punchText placeholder-black outline-none" placeholder={translateTextString(selectedLang, ["home","inboxPlaceholder"], [0])}/>
