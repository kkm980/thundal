export const es: {[page: string]: any} = {
    home: {
        heroTitle: "Conéctate Directamente con Tu Celebridad Favorita:",
        heroSubText: "¡Posee Tu Propio Centro Fans!",
        heroPunch: "¡Conéctate directamente con tu celebridad favorita para interacciones exclusivas como nunca antes!",
        inboxPlaceholder: "Ingresa tu correo electrónico",
        inputBtn: "Regístrate",
        testimonials: [
            {
                text: "La sincronización en tiempo real y la organización impulsada por IA han hecho que nuestro momento de fan sea más eficiente que nunca.",
                author: "Krishna Kant",
    ...
    tutorial: {
        tutorialTitle: "Conéctate Directamente con Tu Celebridad Favorita:",
        heroSubText: "¡Posee Tu Propio Centro de Fans!",
        heroPunch: "¡Conéctate directamente con tu celebridad favorita para interacciones exclusivas como nunca antes!",
        inboxPlaceholder: "Ingresa tu correo electrónico",
        inputBtn: "Regístrate",
